...
def generate_report(base_path, output_dir, subject_name,template_file_path='shortTR_template.html'):
    ...
    data = {
        'title': 'ShortTR Immediately Analysis Result Report',
...
#         ]
    ...
    output_path = os.path.join(output_directory, f'{subject_name}_result_shortTR_normal.html')
    with open(output_path, 'w') as output_file:
        output_file.write(rendered_html)

    config = pdfkit.configuration(wkhtmltopdf=r'C:\Program Files\wkhtmltopdf\bin\wkhtmltopdf.exe')
    output_pdf_path = os.path.join(output_directory, f'{subject_name}_result_shortTR_normal.pdf')
